              ...
              <div className={styles.cardSectionsContainer}>
                ...
                <div className={styles.cardSection}>
                  ...
                  <div className={styles.courseCardsGrid}>
                    {courseVideos.reduce((courses, video) => {
                      // Group videos by course
                      if (!courses[video.course]) {
                        courses[video.course] = 0;
                      }
                      ...
                      <div key={index} className={`${styles.courseCard} ${styles[`brandGradient${index % 3}`]}`}>
                  ...
                  <div className={styles.recentVideosContainer}>
                    {courseVideos.length > 0 ? (
                      ...
                      courseVideos.slice(0, 3).map((video) => (
                        <div key={video._id} className={styles.recentVideoCard}>
                          ...
                          <div className={styles.videoInfo}>
                            ...
                            <div className={styles.videoMeta}>
                              <span className={styles.videoCourse}>{video.course}</span>
                              <span className={styles.videoDuration}>By {video.author}</span>
                            </div>
                          </div>
                        </div>
                      ))
                      ...
                      {events.length > 0 ? (
                        events.map((event) => (
                          <tr key={event._id}>
                            ...
                            <td>
                              <span className={`${styles.eventStatus} ${styles[event.status.toLowerCase().replace(' ', '')]}`}>
                                {event.status}
                              </span>
                            </td>
                          </tr>
