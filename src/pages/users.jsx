                    ...
                    <div className={styles.modalBody}>
                      ...
                      <div className={styles.attestationList}>
                        {currentUser.course_id && Object.entries(currentUser.course_id).map(([courseName, uid]) => {
                          ...
                          return (
                            <div key={`attestation-${courseName}`} className={styles.attestationItem}>
                              <div className={styles.attestationInfo}>
                                <p className={styles.attestationName}>{courseName}</p>
                                <p className={styles.attestationUid}>
                                  {uidString.length > 16 ?
                                    `${uidString.substring(0, 10)}...${uidString.substring(uidString.length - 6)}` :
                                    uidString}
                                </p>
                              </div>
                              <a
